...
if (world.beforeEvents.itemUse) {
    world.beforeEvents.itemUse.subscribe(async (ev) => {
        ...
        // Only process if in Action mode
...
if (world.beforeEvents.playerBreakBlock) world.beforeEvents.playerBreakBlock.subscribe(prevent);
if (world.beforeEvents.playerPlaceBlock) world.beforeEvents.playerPlaceBlock.subscribe(prevent);
if (world.beforeEvents.playerInteractWithBlock) world.beforeEvents.playerInteractWithBlock.subscribe(prevent);
if (world.beforeEvents.playerInteractWithEntity) world.beforeEvents.playerInteractWithEntity.subscribe(prevent);
